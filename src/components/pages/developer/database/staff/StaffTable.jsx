...
const StaffTable = ({setShowInfo, showInfo, staff, isLoading, setItemEdit, setIsAdd, setIsSuccess, setMessage, setStaffInfo}) => {
    ...
    {isActive && <ModalConfirm position="center" setMessage={setMessage} setIsSuccess={setIsSuccess} setIsActive={setIsActive} queryKey="staff" endpoint={`/v1/staff/active/${id}`} isArchiving={isArchiving}/>}
    {isDelete && <ModalDelete position="center" setMessage={setMessage} setIsSuccess={setIsSuccess} setIsDelete={setIsDelete} queryKey="staff" endpoint={`/v1/staff/${id}`} />}
        </>
      )
    }
